...
<!-- SIRF YEH STYLE ADD KIYA HAI - BAAKI KUCH NAHI CHEDA -->
<style>
/* ONLY PROPERTY CARD FIX - Featured apartment ke neeche dabne ka problem solve */
.property-card {
    background: #fff;
    border-radius: 16px;
    overflow: hidden;
...
/* Baaki sab original jaisa hi rahega */
</style>
...
<!-- BAAKI SAB ORIGINAL HAI, KUCH CHANGE NAHI KIYA -->
<?php if (!empty($stats)): ?>
